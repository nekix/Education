...
2) Реализовать с помощью минимального API и изученных в главе инструментов api для операций CRUD со списком фруктов и овощей. Логируйте эти операции на верхнем уровне (объеденив их в группы). Ошибки должны возвращаться в соответствии с `Problem Details`.
