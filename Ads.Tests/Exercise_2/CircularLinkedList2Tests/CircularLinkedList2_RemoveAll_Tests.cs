...
{
    public class CircularLinkedList2_RemoveAll_Tests : CircularLinkedList2_BaseTests
    {
        [Theory]
        [MemberData(nameof(RemoveAllData))]
        public void Should_RemoveAll(int value, int newCount, CircularLinkedList2 list, int[] finalValues)
        {
