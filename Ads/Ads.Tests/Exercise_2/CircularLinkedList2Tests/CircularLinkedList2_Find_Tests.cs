...
{
    public class CircularLinkedList2_Find_Tests : CircularLinkedList2_BaseTests
    {
        [Theory]
        [MemberData(nameof(FindFirstData))]
        public void Should_Find_First(int value, bool isExist, int? prevNodeValue, int? nextNodeValue, CircularLinkedList2 list)
        {
