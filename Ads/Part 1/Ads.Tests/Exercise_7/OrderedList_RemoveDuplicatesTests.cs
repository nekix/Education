    ...
    public class OrderedList_RemoveDuplicatesTests : OrderedList_BaseTests
    {
        ...
        public static IEnumerable<object[]> RemoveDuplicatesData =>
            new List<object[]>
            {
                ...
                new object[] { GetFulledOrderedList(true, new[] { 1, 1, 1, 1, 1 }), 1, new[] { 1 } },

                new object[] { GetFulledOrderedList(true, new[] { 1, 1, 1, 2, 3, 4 }), 4, new[] { 1, 2, 3, 4 } },
                new object[] { GetFulledOrderedList(true, new[] { 1, 2, 3, 4, 4, 4 }), 4, new[] { 1, 2, 3, 4} },

                new object[] { GetFulledOrderedList(true, new[] { 1, 2, 3, 3, 3, 4 }), 4, new[] { 1, 2, 3, 4} },

                new object[] { GetFulledOrderedList(true, new[] { 1, 1, 2, 3, 4, 4, 4, 5, 6, 7, 7, 7, 7 }), 7, new[] { 1, 2, 3, 4, 5, 6, 7 } },
            };
    }
}
