...
namespace CarPark.Data.Migrations
{
    ...
    [Migration("20250924150514_ChangedRidersStartEndPointsOnDeleteBehaviour")]
    partial class ChangedRidersStartEndPointsOnDeleteBehaviour
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarPark.Models.Drivers.Driver", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CarPark.Models.Enterprises.Enterprise", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CarPark.Models.Managers.Manager", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CarPark.Models.Models.Model", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CarPark.Models.Rides.Ride", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CarPark.Models.TzInfos.TzInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CarPark.Models.Vehicles.Vehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("CarPark.Models.Vehicles.VehicleGeoTimePoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_vehicle_get_time");

                    b.HasIndex("vehicle_id")
                        .HasDatabaseName("ix_vehicle_get_time_vehicle_id");

                    b.ToTable("vehicle_get_time", (string)null);
                });
            ...
            modelBuilder.Entity("CarPark.Models.Drivers.Driver", b =>
                {
                    b.HasOne("CarPark.Models.Enterprises.Enterprise", null)
                        .WithMany()
                    ...
                    b.HasOne("CarPark.Models.Vehicles.Vehicle", "ActiveAssignedVehicle")
                        .WithOne("ActiveAssignedDriver")
                        .HasForeignKey("CarPark.Models.Drivers.Driver", "assigned_vehicle_id")
                        .OnDelete(DeleteBehavior.NoAction)
            ...
            modelBuilder.Entity("CarPark.Models.Enterprises.Enterprise", b =>
                {
                    b.HasOne("CarPark.Models.TzInfos.TzInfo", "TimeZone")
                        .WithMany()
            ...
            modelBuilder.Entity("CarPark.Models.Rides.Ride", b =>
                {
                    b.HasOne("CarPark.Models.Vehicles.VehicleGeoTimePoint", "EndPoint")
                        .WithMany()
                        .HasForeignKey("end_geo_time_point_id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_ride_vehicle_get_time_end_geo_time_point_id");

                    b.HasOne("CarPark.Models.Vehicles.VehicleGeoTimePoint", "StartPoint")
                        .WithMany()
                        .HasForeignKey("start_geo_time_point_id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_ride_vehicle_get_time_start_geo_time_point_id");

                    b.HasOne("CarPark.Models.Vehicles.Vehicle", "Vehicle")
                        .WithMany()
            ...
            modelBuilder.Entity("CarPark.Models.Vehicles.Vehicle", b =>
                {
                    ...
                    b.HasOne("CarPark.Models.Models.Model", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CarPark.Models.Vehicles.VehicleGeoTimePoint", b =>
                {
                    b.HasOne("CarPark.Models.Vehicles.Vehicle", "Vehicle")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_vehicle_get_time_vehicle_vehicle_id");
            ...
            modelBuilder.Entity("driver_vehicle_assignment", b =>
                {
                    b.HasOne("CarPark.Models.Drivers.Driver", null)
                        .WithMany()
                    ...
                    b.HasOne("CarPark.Models.Vehicles.Vehicle", null)
                        .WithMany()
            ...
            modelBuilder.Entity("enterprise_manager", b =>
                {
                    ...
                    b.HasOne("CarPark.Models.Managers.Manager", null)
                        .WithMany()
