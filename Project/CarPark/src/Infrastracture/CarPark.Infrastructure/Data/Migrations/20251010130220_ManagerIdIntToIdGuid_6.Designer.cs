...
namespace CarPark.Data.Migrations
{
    ...
    [Migration("20251010130220_ManagerIdIntToIdGuid_6")]
    partial class ManagerIdIntToIdGuid_6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarPark.Data.EntitiesDbConfigurationExtensions+NewEnterprsiseManager", b =>
                {
                    ...
                    b.HasKey("EnterprisesId", "ManagersId")
                        .HasName("pk_enterprsise_manager");

                    b.HasIndex("ManagersId")
                        .HasDatabaseName("ix_enterprsise_manager_managers_id");

                    b.ToTable("enterprsise_manager", (string)null);
                });
            ...
            modelBuilder.Entity("CarPark.Data.EntitiesDbConfigurationExtensions+NewEnterprsiseManager", b =>
                {
                    b.HasOne("CarPark.Enterprises.Enterprise", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_enterprsise_manager_enterprise_enterprises_id");
                    ...
                    b.HasOne("CarPark.Managers.Manager", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_enterprsise_manager_manager_managers_id");
                });
