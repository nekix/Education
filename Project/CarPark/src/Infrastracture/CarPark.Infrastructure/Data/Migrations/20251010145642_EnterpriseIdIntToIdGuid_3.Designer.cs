...
namespace CarPark.Data.Migrations
{
    ...
    [Migration("20251010145642_EnterpriseIdIntToIdGuid_3")]
    partial class EnterpriseIdIntToIdGuid_3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarPark.Vehicles.Vehicle", b =>
                {
                    ...
                    b.Property<Guid>("EnterpriseGuidId")
                        .HasColumnType("uuid")
                        .HasColumnName("enterprise_guid_id");
                    ...
                    b.HasIndex("EnterpriseGuidId")
                        .HasDatabaseName("ix_vehicle_enterprise_guid_id");
            ...
            modelBuilder.Entity("enterprise_manager", b =>
                {
                    b.Property<Guid>("enterprises_id")
                        .HasColumnType("uuid")
                        .HasColumnName("enterprises_id");

                    b.Property<Guid>("managers_id")
                        .HasColumnType("uuid")
                        .HasColumnName("managers_id");

                    b.HasKey("enterprises_id", "managers_id")
                        .HasName("pk_enterprise_manager");

                    b.HasIndex("managers_id")
            ...
            modelBuilder.Entity("CarPark.Vehicles.Vehicle", b =>
                {
                    b.HasOne("CarPark.Enterprises.Enterprise", "Enterprise")
                        .WithMany()
                        .HasForeignKey("EnterpriseGuidId")
                        .HasPrincipalKey("GuidId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
