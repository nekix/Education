...
Вынов в CTE expedition_stats и skills_progression кажется мне логичным. В первом достаточно простые операции присоеденения таблиц и сбора данных, которые желательно вынести отдельно, чтобы можно было эти данные дальше обработать до конечного ответа и не создавать вложенных структур. Во втором случае более сложная логика получения прогрессии, которую тоже неудобно держать вместе с основным запросом, т.к. возникают вложенные структуры и вопросы оформления агрегации этих данных.
